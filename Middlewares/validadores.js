...
module.exports = [
    ...
    check('email').notEmpty().withMessage('É necessário um email').bail().trim().bail().normalizeEmail().bail().isEmail().withMessage('Escreva um formato de email correto'),
    check('emailAbrigo').notEmpty().withMessage('É necessário um email').bail().trim().bail().normalizeEmail().bail().isEmail().withMessage('Escreva um formato de email correto'),
    ...
    check('confirmarSenha').notEmpty().withMessage('A senha precisa ter mais de 6 caracteres').isLength({ min: 6 }).bail().trim(),
